...
export default function Navbar({ fixed }) {
  ...
  return (
    <>
      <nav className="relative flex flex-wrap items-center justify-between px-0 py-5 bg-cyan-500 mb-3 bg-blue-400">
        <div className="container px-10 h-[0rem] flex flex-wrap items-center justify-between ">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start ">
            <a
              className=" text-sm font-sans-serif leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase text-white"
              href="#pablo"
            >
          ...
          <div
            className={
              "lg:flex flex-grow items-center bg-blue" +
          ...
          >
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              <li className="nav-item">
                <a
                  className="px-10 py-2 flex items-center text-xs uppercase font-sans-serif leading-snug text-white hover:opacity-75"
                  href="#pablo"
                >
        ...
        <div class="w-4/5 m-auto shadow-2xl">
			<div class="grid place-items-center mx-auto p-1  bg-white rounded-3xl space-y-10">
            <h1 class="text-5xl font-semibold text-blue-400">Siga-nos nas redes sociais</h1>
